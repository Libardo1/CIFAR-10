...
import numpy
from utils import dropout as DropOut
...
def evaluate_lenet5(learning_rate=1, n_epochs=500,
					dataset='CIFAR10.pkl.gz',
					nkerns=[24, 36,20], batch_size=100):
	...
	layer0_input = DropOut(layer0_input, 0.2)
	...
	layer2_input = DropOut(layer2_input, 0.1)
	...
	layer3_input = DropOut(layer2.output, 0.1)
	...
	patience_increase = 2  # wait this much longer when a new best is
						   # found
	improvement_threshold = 0.80  # a relative improvement of this much is
